...
export const industriesData: Industry[] = [
  ...
  {
    name: "בינוי, תשתיות ונדל\"ן",
    roles: [],
  },
  {
    name: "גרפיקה, עיצוב ואומנות",
    roles: [],
  },
  {
    name: "מסעדנות, מזון ואירועים",
    roles: [],
  },
  {
    name: "תעופה אווירונאוטיקה וימאות",
    roles: [],
  },
  {
    name: "מחשוב רשתות ותוכנה",
    roles: [],
  },
  {
    name: "חשבונאות וכספים",
    roles: [],
  },
  {
    name: "שיווק ופרסום",
